class contentSlider {
    ...
    static createInstances() {
      document.querySelectorAll('[data-slider="content-slider"]').forEach((el) => {
        const { dataset } = el;
        const params = {};
    ...
    #onClick(e) {
      ...
      if (!(e.target.closest('.content-slider-btn') || e.target.closest('.content-slider-indicators'))) {
        return;
      }
